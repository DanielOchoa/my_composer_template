...
@recipes = ["core", "setup", "email", "gems", "readme", "frontend", "testing", "models", "apps4", "init", "prelaunch", "saas", "extras"]
@prefs = {apps4: 'none', dev_webserver: 'thin', prod_webserver: 'thin', database: 'postgresql', templates: 'haml', unit_test: 'rspec',
integration: 'rspec-capybara', continuous_testing: 'guard', fixtures: 'factory_girl', frontend: 'bootstrap', bootstrap: 'sass', email: 'sendgrid',
authentication: 'devise', devise_modules: 'default', authorization: 'cancan', form_builder: 'simple_form', starter_app: 'none', local_env_file: true }
...
after_bundler do
  unless prefer :database, 'default'
    ...
    if prefer :database, 'postgresql'
      begin
        # with postgresql I don't need username password fields.
        gsub_file "config/database.yml", /username: .*/, ''
        gsub_file "config/database.yml", /password:/, ''
        # let's inject my settings
        inject_into_file 'config/database.yml', "host: localhost\nencoding: unicode\n", after: "adapter: postgresql\n"
